...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>AH City - Coming Soon</title>
      </Head>
            ...
            <div className="lg:w-8/12 mt-6 md:mt-8 lg:mt-0">
              <div className="relative w-full h-full">
                ...
                <div className="hidden lg:block absolute bottom-0 right-0 bg-red-200 w-1/2">
                  <button className="dark:hover:bg-[#b9805a] dark:bg-[#b9805a] dark:hover:text-gray-200 dark:text-white bg-gray-800 text-xl xl:text-2xl font-medium text-white flex justify-between w-full items-center p-5 xl:p-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700">
                    Coming Soon!
                    <div>
